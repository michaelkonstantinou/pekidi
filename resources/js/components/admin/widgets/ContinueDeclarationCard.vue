...
<template>
    ...
    >
        <div
            class="group relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900 via-slate-900 to-indigo-950 p-6 text-white shadow-2xl ring-1 ring-white/10 transition-all duration-300 hover:shadow-indigo-500/10 hover:ring-white/20 sm:p-8"
        >
