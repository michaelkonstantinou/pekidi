              ...
              <span class="relative z-10 bg-background px-2 text-muted-foreground">
                Or continue with
                                ...
                                <div class="text-center text-sm">
                                    ...
                                    <router-link :to="{'name': 'auth.register'}" class="underline underline-offset-4">
                                        {{ $t("auth.sign_up") }}
                                    </router-link>
                                </div>
                            </div>
